...
SimInfo createSimulation(string _simName, GraphicsEngine* _engine){
    ...
    else if(_simName == "EvacuationSimulation") return SimInfo(new EvacuationSimulation(2, 50, 300, 5, 30, NULL, _engine->getResourceManager(), seed), "neuralxmls/evacuationsimulation/input6h.xml", "neuralxmls/evacuationsimulation/output.xml");
